...
$pdf->SetAuthor('Hawari');
$pdf->SetTitle('Laporan Transaksi CV Anugrah Pratama Prakarsa');
...
$header .= '
		...
		<tr style="padding:80px; text-align: center;">
			<th style="padding:80px; text-align: center;"><h3><b>CV. Anugrah Pratama Prakarsa</b></h3></th>
		</tr>
		<tr style="padding:30px; text-align: center;">
			<th>Jl. Talang Gading No.28, Kec. Kalidoni, Kota Palembang, Sumatera Selatan 30119</th>
		</tr>
