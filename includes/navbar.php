			...
			<ul class="navbar-nav ms-auto justify-content-end">
				<li class="nav-item d-flex align-items-center dropdown">
					...
					<ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
						...
						<li class="mb-2">
							<a class="dropdown-item border-radius-md" href="pengguna/profil/">
								<div class="d-flex py-1">
									<div class="my-auto">
										<img src="assets/img/profil/<?= $_SESSION['foto'] ?>" class="avatar avatar-sm  me-3 ">
									</div>
						...
						<li class="d-flex justify-content-end">
							<a href="aksi_logout.php" class="w-100 btn btn-info"><i class="material-icons opacity-10">logout</i> Logout</a>
						</li>
					</ul>
				</li>
