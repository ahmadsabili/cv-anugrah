...
?>
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-faded-info"
	id="sidenav-main">
	<div class="sidenav-header">
		...
		<a class="navbar-brand m-0" href="dashboard">
			...
			<span class="ms-1 font-weight-bold text-white" translate="no" style="font-size: 12px;">CV. Anugrah Pratama Prakarsa</span>
		</a>
	</div>
	...
	<div class="collapse navbar-collapse  w-auto h-auto max-height-vh-100" id="sidenav-collapse-main">
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link text-white <?php if($_GET['module'] == 'pemasukan'){ echo 'active bg-gradient-warning';} ?>" href="main.php?module=pemasukan">
					<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
						<i class="material-icons opacity-10" translate="no">table_view</i>
					</div>
			...
			<li class="nav-item">
				<a class="nav-link text-white <?php if($_GET['module'] == 'pengeluaran'){ echo 'active bg-gradient-warning';} ?>" href="main.php?module=pengeluaran">
					<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
			...
			<li class="nav-item">
				<a class="nav-link text-white <?php if($_GET['module'] == 'hutang'){ echo 'active bg-gradient-warning';} ?>" href="main.php?module=hutang">
					<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
						<i class="material-icons opacity-10" translate="no">table_view</i>
					</div>
			...
			<li class="nav-item">
				<a class="nav-link text-white <?php if($_GET['module'] == 'piutang'){ echo 'active bg-gradient-warning';} ?>" href="main.php?module=piutang">
					<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
						<i class="material-icons opacity-10" translate="no">receipt_long</i>
					</div>
			...
			<li class="nav-item">
				<a class="nav-link text-white <?php if($_GET['module'] == 'laporan'){ echo 'active bg-gradient-warning';} ?>" href="main.php?module=laporan">
					<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
			...
			<?php if($_SESSION['role'] == 'admin'){ ?>
				...
				<li class="nav-item">
					<a class="nav-link text-white <?php if($_GET['module'] == 'pengguna' || $_GET['module'] == 'profile'){ echo 'active bg-gradient-warning';} ?>" href="main.php?module=pengguna">
						<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
