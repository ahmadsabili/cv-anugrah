...
$q_pendapatan = mysqli_query($con, "select sum(jumlah) as pendapatan_sekarang from pemasukan where date(tanggal) = '$tglSekarang'");
$pendapatan = mysqli_fetch_array($q_pendapatan);

$q_pengeluaran = mysqli_query($con, "select sum(jumlah) as pengeluaran_sekarang from pengeluaran where date(tanggal) = '$tglSekarang'");
$pengeluaran = mysqli_fetch_array($q_pengeluaran);


$q_transaksi = mysqli_query($con, "select sum(jumlah) as transaksi_sekarang from pemasukan where date(tanggal) = '$tglSekarang'");
$transaksi = mysqli_fetch_array($q_transaksi);

$q_tpemasukan = mysqli_query($con, "select * from pemasukan where date(tanggal) = '$tglSekarang'");
$tpemasukan = mysqli_num_rows($q_tpemasukan);

$q_tpengeluaran = mysqli_query($con, "select * from pengeluaran where date(tanggal) = '$tglSekarang'");
...
from pemasukan where MONTH(tanggal) = '$bulansekarang' and YEAR(tanggal) = '$tahunsekarang '");
$pendapatan_bulan = mysqli_fetch_array($q_pendapatan_bulan);

$q_pengeluaran = mysqli_query($con, "select sum(jumlah) as pengeluaran_bulan from pengeluaran where MONTH(tanggal) = '$bulansekarang' and YEAR(tanggal) = '$tahunsekarang ' ");
$pengeluaran_bulan = mysqli_fetch_array($q_pengeluaran);

$q_tpemasukan_bulan = mysqli_query($con, "select * from pemasukan where MONTH(tanggal) = '$bulansekarang' and YEAR(tanggal) = '$tahunsekarang '");
$tpemasukan_bulan = mysqli_num_rows($q_tpemasukan_bulan);

$q_tpengeluaran_bulan = mysqli_query($con, "select * from pengeluaran where MONTH(tanggal) = '$bulansekarang' and YEAR(tanggal) = '$tahunsekarang '");
...
$q_hutang = mysqli_query($con, "select sum(jumlah) as utang_sekarang from pemasukan where date(tanggal) = '$tglSekarang'");
$hutang = mysqli_fetch_array($q_hutang);

$q_piutang = mysqli_query($con, "select sum(jumlah) as piutang_sekarang from piutang where date(tanggal) = '$tglSekarang'");
...
from hutang where MONTH(tanggal) = '$bulansekarang' and YEAR(tanggal) = '$tahunsekarang '");
