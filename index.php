...
<html lang="en">
<head>
<title>	CV. Anugrah Pratama Prakarsa</title>
...
<section style="padding: 2em 0;">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-6 text-center mb-5">
				<h2 class="heading-section">CV. Anugrah Pratama Prakarsa</h2>
			</div>
		</div>
		<div class="row justify-content-center">
			<div class="col-md-6 col-lg-4">
				<div class="login-wrap py-5">
					<div class="img d-flex align-items-center justify-content-center" style="background-image:url(assets/img/logocv.jpg)">
					</div>
					...
					<form method="post">
						...
						<div class="form-group">
							<button type="submit" name="kirim" class="btn form-control btn-primary rounded submit px-3">LOGIN</button>
						</div>
    ...
    if(isset($_POST['kirim'])) {
		...
		if(mysqli_num_rows($login)>0) {
			...
			echo "<script>alert('Username / Password Salahh')</script>";
		}
